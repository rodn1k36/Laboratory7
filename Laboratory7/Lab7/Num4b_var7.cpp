...
//
//	xr.push_back(((double)(rand() % 1000) - 500) / 100);
...
//		std::cout << "Metod Monte-Karlo: " << (double)n / (double)N * 100;
//		exit(1);
//	}
//	++N;
...
//	for (int i = 0; i < (int)(p * 2) * 100; i += 1) { // координаты графика
...
//	glLoadIdentity();
//	gluOrtho2D(-5, 5, -5, 5); // нормальные координаты а не через float
